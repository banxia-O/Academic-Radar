...
一个**给临床医生 / 医学方向科研人员 / 研究生**的学术信息雷达插件。按你设定的频率（每天 / 每周 / 每月，或开会期间每几小时）定时从 PubMed、Semantic Scholar、OpenAlex、bioRxiv、medRxiv、X（推特）、RSS 抓取你研究方向相关的论文，LLM 打分筛选去重后，推送到你的微信、Telegram、Slack 或邮箱。
